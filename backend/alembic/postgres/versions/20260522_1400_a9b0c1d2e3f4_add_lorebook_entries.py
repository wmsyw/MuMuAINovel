...
def upgrade() -> None:
    ...
    op.create_index("ix_lorebook_entries_project_id", "lorebook_entries", ["project_id"], unique=False)
    op.create_index("ix_lorebook_entries_user_id", "lorebook_entries", ["user_id"], unique=False)
    op.create_index("idx_lorebook_entries_project_user_priority", "lorebook_entries", ["project_id", "user_id", "priority"], unique=False)
    op.create_index("idx_lorebook_entries_project_enabled", "lorebook_entries", ["project_id", "enabled"], unique=False)


def downgrade() -> None:
    op.drop_index("idx_lorebook_entries_project_enabled", table_name="lorebook_entries")
    op.drop_index("idx_lorebook_entries_project_user_priority", table_name="lorebook_entries")
    op.drop_index("ix_lorebook_entries_user_id", table_name="lorebook_entries")
    op.drop_index("ix_lorebook_entries_project_id", table_name="lorebook_entries")
